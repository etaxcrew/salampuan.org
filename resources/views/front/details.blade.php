...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-banner-content wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                            <h4 class="page-title"><b>{{ $post->title }}</b> <br><span style="font-size: 20px">{{
                                    TanggalID($post->publish) }}</span></h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="growth_area pt-50 pb-30">
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="growth_content mt-100">
                        ...
                        <div class="mt-25 pb-15">
                            <img src="{{ $post->image }}" alt="{{ $post->title }}" width="100%" height="600px">
                        </div>
